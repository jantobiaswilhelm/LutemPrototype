...
// All Game Card Component (Grid View)
function AllGameCard({ game }: { game: Game }) {
  // Use Steam CDN for cover images if we have a steamAppId
...
// All Game Row Component (List View)
...
// My Games Tab Content (existing logic extracted)
...
// Game Card Component (Grid View) - for user's library
...
// Game Row Component (List View) - for user's library
